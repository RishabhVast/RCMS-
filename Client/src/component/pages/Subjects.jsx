        ...
        <table className="w-1/2  ">
          ...
          <tbody className=" text-left bg-cyan-900 text-white ">
            {subjects.map((subject) => (
              <tr className=" border-b-2 border-black  " key={subject._id}>
                ...
                <td className="px-6 py-2 whitespace-no-wrap ">
                  <div className="font-bold leading-5 "> {subject.name}</div>
                </td>
                ...
                <td className=" px-6 py-2 hitespace-no-wrap font-bold leading-5">
                  <button
                    ...
                    onClick={() => {
                      deleteSubject(subject._id).then(() => retrieveSubjects())
                    }}
                  >
                    Delete
                  </button>
